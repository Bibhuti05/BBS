...
const SkillCard: React.FC<{ skill: Skill; index: number; isVisible: boolean }> = ({ skill, index, isVisible }) => {
  ...
  return (
    <div 
      className="group p-6 rounded-2xl bg-white dark:bg-zinc-800 border border-zinc-100 dark:border-zinc-700 hover:border-primary-500/50 dark:hover:border-primary-500/50 shadow-sm hover:shadow-lg hover:shadow-primary-500/10 transition-all duration-300 transform hover:-translate-y-1"
    >
      <div className="flex items-center justify-between mb-4">
        ...
        <span className="text-2xl font-bold text-zinc-300 dark:text-zinc-600 group-hover:text-primary-500/20 transition-colors">
          0{index + 1}
        </span>
      </div>
